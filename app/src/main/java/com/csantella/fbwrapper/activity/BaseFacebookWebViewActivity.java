...
package com.csantella.fbwrapper.activity;
...
import com.csantella.fbwrapper.R;
import com.csantella.fbwrapper.util.Logger;
import com.csantella.fbwrapper.util.OrbotHelper;
import com.csantella.fbwrapper.util.WebViewProxyUtil;
import com.csantella.fbwrapper.webview.FacebookWebChromeClient;
import com.csantella.fbwrapper.webview.FacebookWebView;
import com.csantella.fbwrapper.webview.FacebookWebViewClient;
...
public abstract class BaseFacebookWebViewActivity extends Activity implements
    ...
    protected final static String URL_FRIENDS_CENTER = "/friends/center/mbasic/?fb_ref=tn&amp;sr=1&amp;ref_component=mbasic_home_header&amp;ref_page=MFriendsCenterMBasicController";
    protected final static String URL_PAGE_SEARCH = "/search";
    protected final static String URL_PAGE_MENU = "/menu/bookmarks/";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        newsfeedBtn = (ImageView) findViewById(R.id.newsfeed_button);
        friendsBtn = (ImageView) findViewById(R.id.friends_button);
        messagesBtn = (ImageView) findViewById(R.id.messages_button);
        notifBtn = (ImageView) findViewById(R.id.notif_button);
    ...
    /**
     * Set a proxy for the {@link com.csantella.fbwrapper.webview.FacebookWebView}
     *
    ...
    /**
     * OnClick methods for the new NavBar buttons
     */
...
/**
    ...
    protected final static String URL_PAGE_NOTIFICATIONS = "/notifications.php";
    protected final static String URL_PAGE_MESSAGES = "/messages";
    protected final static String URL_FRIENDS_CENTER = **SEE ABOVE**
    protected final static String URL_PAGE_SEARCH = "/search";
    protected final static String URL_PAGE_MENU = "/menu/bookmarks/";
    */

    public void nfClick(View v)
    {
        //News feed button clicked
    ...
    public void frClick(View v)
    {
        ...
        loadNewPage(INIT_URL_MOBILE + URL_FRIENDS_CENTER);
    }

    public void msgClick(View v)
    {
        //Messages button clicked
        loadNewPage(INIT_URL_MOBILE + URL_PAGE_MESSAGES);
    }

    public void ntfClick(View v)
    {
        //Notification button clicked
        loadNewPage(INIT_URL_MOBILE + URL_PAGE_NOTIFICATIONS);
    }

    public void scClick(View v)
    {
        //Notification button clicked
        loadNewPage(INIT_URL_MOBILE + URL_PAGE_SEARCH);
    }

    public void stClick(View v)
    {
        //Notification button clicked
        loadNewPage(INIT_URL_MOBILE + URL_PAGE_MENU);
    }
